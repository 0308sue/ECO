...
class RankingPage extends StatelessWidget {
  ...
  static const Color _primaryColor =
      EcoColors.primary;
  static const Color _secondaryGreen =
      EcoColors.secondary;
  static const Color _textColor =
      EcoColors.text;
  static const Color _mutedTextColor =
      EcoColors.muted;
  static const Color _creamColor =
      Color(0xFFFFF6D8);
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: StreamBuilder<List<RankingUser>>(
          stream: _rankingService.watchTopUsers(
            limit: 120,
          ),
          builder: (context, snapshot) {
            ...
            if (users.isEmpty) {
              return const _RankingEmptyState(
                ...
                message:
                    '이번 달 영수증을 올리면 랭킹에 표시됩니다.',
              );
            }

            final currentUser =
                _findCurrentUser(users);
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        SizedBox(height: 6),
        Text(
          '이번 달 에코 포인트 경쟁을 확인해요.',
          style: TextStyle(
            color:
                RankingPage._mutedTextColor,
            fontSize: 14,
...
class _MyRankingDashboard
  ...
  @override
  Widget build(BuildContext context) {
    final rankText = currentUser == null
        ? '순위 없음'
        : '${currentUser!.rank}위';
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              '현재 1위 ${topUser.nickname} · '
              '${_formatNumber(topUser.ecoPoint)} pts',
...
class _GreenInfoTile
    extends StatelessWidget {
  const _GreenInfoTile({
    required this.title,
    required this.value,
  });
...
class _PodiumTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final points = user == null
        ? '-'
        : _formatNumber(user!.ecoPoint);
