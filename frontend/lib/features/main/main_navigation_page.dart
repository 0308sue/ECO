...
class _MainNavigationPageState
  ...
  bool _isEcoPlaceMapOpen = false;

  void _moveTab(int index) {
    setState(() {
      _currentIndex = index;
      _isEcoPlaceMapOpen = false;
    });
  }

  void _openEcoPlaceMap() {
    setState(() {
      _isEcoPlaceMapOpen = true;
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _isEcoPlaceMapOpen
          ? EcoPlaceMapPage(
              onBack: _closeEcoPlaceMap,
              bottomInset: 116,
            )
          : IndexedStack(
              index: _currentIndex,
