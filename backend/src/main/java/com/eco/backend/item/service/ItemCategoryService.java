...
public class ItemCategoryService {
    ...
    private final List<ItemCategoryRule> rules = List.of(
            ...
            new ItemCategoryRule("식품", "조리음식", 850, List.of(
                    "짜장면", "자장면", "짬뽕", "탕수육", "중식",
                    "마라탕", "마라샹궈", "꿔바로우", "라멘", "우동", "칼국수",
                    "국밥", "찌개", "김치찌개", "된장찌개", "백반",
                    "돈까스", "돈가스", "제육", "제육볶음", "비빔밥",
                    "냉면", "족발", "보쌈", "찜닭", "닭갈비",
                    "치킨", "후라이드", "양념치킨", "피자", "떡볶이",
            ...
            new ItemCategoryRule("식품", "배달음식", 950, List.of(
                    "배달음식", "배달주문", "포장주문",
                    "배민", "배달의민족", "요기요", "쿠팡이츠"
            )),
            new ItemCategoryRule("식품", "배달서비스", 300, List.of(
                    "배달팁", "배달비", "배달료", "배달요금",
                    "배달수수료", "배달대행료"
            )),
